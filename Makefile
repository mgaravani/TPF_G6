...
main: Frontend_Allegro/allegro.o Backend/logica.o Backend/main.o Backend/delay.o Frontend_Allegro/eventos.o 
	...
	gcc Frontend_Allegro/allegro.o Frontend_Allegro/eventos.o Backend/main.o Backend/delay.o Backend/logica.o -g -o main -Wall -lallegro -lallegro_primitives -lallegro_font -lallegro_ttf -lpthread
