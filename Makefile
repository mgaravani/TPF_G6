...
main: Frontend_Allegro/allegro.o Backend/logica.o Backend/main.o 
	# Enlaza los archivos objeto y genera el ejecutable 'main', enlazando las bibliotecas necesarias
	gcc Frontend_Allegro/allegro.o Backend/main.o Backend/logica.o -g -o main -Wall -lallegro -lallegro_primitives -lallegro_font -lallegro_ttf -lpthread

# Regla para compilar 'allegro.c' en el archivo objeto 'allegro.o'
Backend/allegro.o: Frontend_Allegro/allegro.c Frontend_Allegro/allegro.h
	# Compila 'allegro.c' con advertencias habilitadas
	gcc Frontend_Allegro/allegro.c -c -Wall -o Frontend_Allegro/allegro.o
